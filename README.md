...
## ✅ Statut de la base `v1.1.3`

`Bougnat_darts_counter` est aligné pour la release open source stable `v1.1.3`, centrée sur :
...
Le runtime supporté en `v1.1.3` ne dépend d’aucun backend métier obligatoire.
...
La frontiere `v1.1.3` impose qu aucune logique proprietaire ne soit necessaire pour lancer, scorer, corriger, annuler, terminer et reprendre localement une partie.
...
- [Notes de version v1.1.3](docs/release/v1.1.3.md)
- [Coverage map v1.1.3](docs/release/v1.1.3-coverage-map.md)
