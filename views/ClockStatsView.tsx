  ...
  return (
    <div className="flex h-[100dvh] flex-col overflow-hidden bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <div className="shrink-0 px-4 pt-5 pb-4 text-center sm:pt-6">
         <h1 className="text-2xl font-black italic text-transparent bg-clip-text bg-gradient-to-br from-orange-500 via-red-500 to-orange-500 drop-shadow-[0_5px_15px_rgba(234,88,12,0.4)] sm:text-3xl md:text-5xl">
      ...
      <div className="mb-4 flex-1 w-full max-w-4xl mx-auto overflow-y-auto px-3 custom-scrollbar sm:px-4">
         <div className="space-y-5 rounded-2xl border border-gray-800 bg-gray-900/50 p-3 shadow-2xl sm:p-4 sm:space-y-6">
                    ...
                    <div key={p.id} className="border-b border-gray-800 pb-4 last:border-0">
                        <div className="mb-3 flex items-center justify-between gap-3">
                            <div className="flex min-w-0 items-center gap-3">
                                ...
                                <span className="truncate font-bold text-base sm:text-lg">{p.name}</span>
                            </div>
...
const StatBox = ({ label, value }: { label: string, value: string | number }) => (
    <div className="rounded bg-gray-800/40 p-2 text-center">
