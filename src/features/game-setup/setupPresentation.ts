...
export const getRulesContent = (
  ...
  if (gameType === 'CAPITAL') {
    return {
      ...
      items: [
        'Ordre des challenges : Capital, 20, Suite, 19, 3 a cotes, 18, 57 points, 17, Couleur, 16, Triple, 15, Double, 14, Moins de 21, 13, Bulle ou D-Bull.',
        ...
        'Moins de 21 : la visite est reussie si le total des 3 flechettes est strictement inferieur a 21. Bulle ou D-Bull : un bull simple ou double valide le challenge.',
