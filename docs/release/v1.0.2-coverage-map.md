...
- `spec:counter/voice-scoring-reliability`
	- Code: `src/features/x01/voice/`, `lib/deepgramToken.ts`, `functions/api/deepgram/token.ts`, `vite.config.ts`
...
- `spec:counter/release-v1.0.2-stabilization`
	- Code: `README.md`, `docs/architecture.md`, `docs/product-scope.md`, `docs/release/v1.0.2.md`, `docs/release/v1.0.2-coverage-map.md`, `package.json`, `package-lock.json`, `.npmrc`, `public/_headers`, `scripts/deployment-check.mjs`
